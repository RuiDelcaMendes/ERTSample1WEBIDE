sap.ui.define([
	...
	function getFrameUrl (sHash, sUrlParameters) {
		var sUrl = jQuery.sap.getResourcePath("ertsample1/ERTSample1/app", ".html");
		sHash = sHash || "";
	...
	return Opa5.extend("ertsample1.ERTSample1.test.integration.pages.Common", {
		...
		getMockServer : function () {
			return new Promise(function (success) {
				Opa5.getWindow().sap.ui.require(["ertsample1/ERTSample1/localService/mockserver"], function (mockserver) {
